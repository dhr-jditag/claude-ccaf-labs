...
def coordinator_v3(ticket_id: str, raw_ticket: str, customer_email: str) -> TicketContext:
    print("=" * 60)
    print("Coordinator V3 (Exercise 4) Started")
    print("=" * 60)
...
"""
    coordinator_v3(ticket_id, raw_ticket, customer_email)
